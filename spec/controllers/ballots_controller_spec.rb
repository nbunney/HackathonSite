  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created ballot" do
        post :create, {:ballot => valid_attributes}, valid_session
        expect(response).to redirect_to(Ballot.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved ballot as @ballot" do
        post :create, {:ballot => invalid_attributes}, valid_session
        expect(assigns(:ballot)).to be_a_new(Ballot)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested ballot" do
        ballot = Ballot.create! valid_attributes
        put :update, {:id => ballot.to_param, :ballot => new_attributes}, valid_session
        ballot.reload
      ...
      it "redirects to the ballot" do
        ballot = Ballot.create! valid_attributes
        put :update, {:id => ballot.to_param, :ballot => valid_attributes}, valid_session
        expect(response).to redirect_to(ballot)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the ballot as @ballot" do
        ballot = Ballot.create! valid_attributes
        put :update, {:id => ballot.to_param, :ballot => invalid_attributes}, valid_session
        expect(assigns(:ballot)).to eq(ballot)
      end
